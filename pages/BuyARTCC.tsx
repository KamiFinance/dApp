import {
  ...
  const BuyARTCM = () => {
    const tokenAddress = "0xfCc58E427B9DB852480D09F93a5Fd572986DD24e";
      ...
      <div className={styles.container}>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <h2 className={styles.title}>Buy ARTCC Tokens</h2>
            <p className={styles.explain}>
              Buy BEP20 tokens from{" "}
              <span >Artchain Circle Cash</span>
            </p>
          </>
        )}
