...
const ListingPage: NextPage = () => {
  ...
  async function createBidOrOffer() {
    try {
      ...
      if (networkMismatch) {
        switchNetwork && switchNetwork(ChainId.BinanceSmartChainTestnet);
        return;
      }
      ...
      if (listing?.type === ListingType.Direct) {
        await marketplace?.direct.makeOffer(
          ...
          1, // Quantity = 1
          NATIVE_TOKENS[ChainId.BinanceSmartChainTestnet].wrapped.address, // Wrapped Ether address on BinanceSmartChainTestnet
